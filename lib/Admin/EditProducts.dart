...
class EditProducs extends StatefulWidget {
  final int id;
  ...
  const EditProducs({Key? key, required this.id, required this.name, required this.price, required this.qty, required this.categorie_id}) : super(key: key);

  @override
  State<EditProducs> createState() => EditProducsState(this.id,this.name,this.price,this.qty,this.categorie_id);
}


class EditProducsState extends State<EditProducs> {
  ...
  EditProducsState(this.id,this.name,this.price,this.qty,this.categorie_id);
  var nameController;
  var priceController;
  var qtyController;
  @override
  ...
  Future<Producs> ActionES({
    ...
    final response = await http.put(Uri.parse('http://$link/api/products/$id'),
    ...
    if (statut == 200) {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) =>ProductsAdd(id: categorie_id)));
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          FormBuilderValidators.compose([
                                            FormBuilderValidators.integer(
                                                errorText:
                                                "La quantiter est invalide"),
                                            FormBuilderValidators.required(
                                                errorText: "La quantiter est vide"),
                                          ]),
